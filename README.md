...
* [MMT: A Matlab Library for Multi-Task Learning](http://publish.illinois.edu/xiaohuichen/code/mmt/)
* [MMT: A Matlab Library for Multi-Task Learning (More)](http://ece.ubc.ca/~xiaohuic/code/multi-task_lasso/multi-task_lasso.htm)
